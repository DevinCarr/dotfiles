...
call s:h("PreCondit", { "fg": s:red }) " preprocessor #if, #else, #endif, etc.
...
call s:h("MatchParen", { "fg": s:green, "bg": s:cursor_grey }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
